...
void Excersize_3_9(int solution, int answer)
{
    ...
    printf("속도가 %5.2lf km/h 인 태풍의 눈이 북서쪽 %5.2lf° 방향으로 통과해 지나간다.\n", speed, angle);
    ...
    printf("(b) 속도가 %5.2lf km/h 인 태풍이 %5.2lf h 동안 이동한 거리\n\n", Changed_Speed, Later_hour);
    ...
    if (solution == SHOW)
    {
        ...
        printf("r: 변위, x1: 북서쪽으로 이동한 거리, y1: 북서쪽으로 이동한 동안의 수평 변위\n\n");

        printf("각도 기준은 북쪽을 기준으로 %5.2lf° 입니다.\n\n", angle);
