...
void Excersize_2_24(int solution, int answer) {
...

	{
		...
		printf("%5.2lf m = %5.2lf + %5.2lf *t + (1/2) %5.2lf m/s^2 t^2\n", x0, v0, height, gravitational_acceleration);
		...
		printf("다음식에 숫자를 대입하면\n");
		printf("x = %5.2lf + %5.2lf m\n", x0, initial_velocity * sqrt(x));
